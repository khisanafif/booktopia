            ...
            <div class="container-fluid px-4 px-lg-5 ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <?php 
                        $cat_qry = $conn->query("SELECT * FROM kategori where status = 1  limit 3");
                        $count_cats =$conn->query("SELECT * FROM kategori where status = 1 ")->num_rows;
                        while($crow = $cat_qry->fetch_assoc()):
                          $sub_qry = $conn->query("SELECT * FROM sub_kategori where status = 1 and parent_id = '{$crow['id']}'");
