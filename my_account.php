                ...
                <div class="w-100 justify-content-between d-flex">
                    ...
                    <table class="table table-stripped text-dark">
                        ...
                        <tbody>
                            <?php 
                                $i = 1;
                                $qry = $conn->query("SELECT o.*,concat(k.nama_depan,' ',k.lastname) as klien  from `pemesanan` p inner join klien k on k.id = p.id_klien where p.id_klien = '".$_settings->userdata('id')."' order by unix_timestamp(p.waktu_dibuat) desc ");
